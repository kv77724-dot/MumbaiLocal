        ...
        <View style={styles.container}>
            <View style={styles.card}>
                ...
                <View style={{flexDirection:'row',alignSelf:"stretch",padding: 5}}>
                    <DropDownPicker
                        items={[{ label: 'Borivali', value: 'bv' },{ label: 'Kandivali', value: 'kn' }, { label: 'Malad', value: 'ml' },
                        { label: 'Goregaon', value: 'grg' },{ label: 'Ram mandir', value: 'rm' }]}
                        containerStyle={{height: 45, flex:1}}
                        style={{backgroundColor:"#f7f6e7",borderWidth:1,borderColor:"#314e52"}}
                ...
                <View style={{flexDirection:'row',alignSelf:"stretch",padding: 5, marginTop:20}}>
                    <View style={{flex:1,paddingRight:5}}>
                        <Text style={styles.field_name}>Adult</Text>
                        <DropDownPicker
                            items={[{ label: 'One (1)', value: 'one' }, { label: 'Two (2)', value: 'two' },
                            { label: 'Three (3)', value: 'three' },{ label: 'Four (4)', value: 'four' }]}
                    ...
                    <View style={{flex:1,paddingLeft:5}}>
                        ...
                        <DropDownPicker
                            items={[{ label: 'Zero (0)', value: 'zero' },{ label: 'One (1)', value: 'one' }, { label: 'Two (2)', value: 'two' },
                            { label: 'Three (3)', value: 'three' },{ label: 'Four (4)', value: 'four' }]}
                            containerStyle={{ height: 30 }}
                            defaultValue='zero'
                        />
                ...
                <View style={{flexDirection:'row',alignSelf:"stretch",padding: 5, marginTop:10}}>
                    <View style={{flex:1,paddingRight:5}}>
                        ...
                        <DropDownPicker
                            items={[{ label: 'Journey', value: 'journey' }, { label: 'Return', value: 'return' }]}
                            containerStyle={{ height: 30 }}
                    ...
                    <View style={{flex:1,paddingLeft:5}}>
                        ...
                        <DropDownPicker
                            items={[{ label: 'Ordinary', value: 'ordinary' },{ label: 'AC Emu', value: 'ac' }]}
                            containerStyle={{ height: 30 }}
                ...
                <View style={{flexDirection:'row',alignSelf:"stretch",padding: 5, marginTop:10}}>
                    ...
                    <View style={{flex:1,paddingLeft:5}}>
                        ...
                        <DropDownPicker
                            items={[{ label: 'Google Pay', value: 'gpay' },{ label: 'Other UPI/ Net Banking/ Debit Card', value: 'other' }]}
                            containerStyle={{ height: 30 }}
                            defaultValue='gpay'
                        />
                    </View>
